           ...
           <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <div class="col-sm-6 col-md-6 col-lg-8">
                  ...
                  <div class="input-group" style="width: 100%;">
                      <input type="text" style="position: relative;" id="srch_bar" class="form-control" placeholder="Search" name="q">
                      <div class="srch-drop">
                        <ul>
                  ...
                  <input type="hidden" name="_token" value="{{ csrf_token() }}" id="token_sch">
                  </form>
              </div>
                <ul class="nav navbar-nav navbar-right">
