            	...
            	@foreach ($bests as $best)
                	<li>
                	    ...
                	    <section class="caption">
                            ...
                            {!!Form::open(['route' =>'actionAdmin', 'method' => 'POST'])!!}  
						...
						@foreach ($lastest as $last)
							<div class="item-mst-list col-lg-12" style="background-image: url('{!! asset('uploads/Review/' . $last->portada) !!}');">
								...
								<div class="col-xs-10 col-md-10 col-sm-10 col-lg-10">
									...
									<a href="/Review/{!! $last->id !!}" class="btn btn-warning col-lg-1 col-md-1 col-sm-1 col-xs-12" ><span class="glyphicon glyphicon-eye-open"></span></a>
                                    {!!Form::open(['route' =>'actionAdmin', 'method' => 'POST'])!!}  
